...
<%--                    <th class="payment">결제 방식</th>--%>
                ...
                <c:forEach var="item" items="${prevReservationList}">
                    <tr class="boardBody">
                        ...
                        <td class="start_date"><fmt:formatDate value="${item.packageStartDate}" pattern="yyyy-MM-dd" type="date"/></td>

                        <td class="product_price">${item.packagePrice}</td>
                            <%--                        <td class="reserve_people">${item}</td>--%>
                            <%--                        <td class="total_price">${item.packagePrice}</td>--%>
            ...
            <table class="mr_b">
                ...
                <c:forEach var="item" items="${nextReservationList}">
                    <tr class="boardBody">
                        ...
                        <td class="product_price">${item.packagePrice}</td>
                        <td class="payment">${item.packagePrice}</td>
